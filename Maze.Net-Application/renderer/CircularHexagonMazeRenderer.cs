...
{
    internal class CircularHexagonMazeRenderer : MazeRenderer<CircularHexagonMazeField>
    {
        protected override void DrawField(Graphics grap, CircularHexagonMazeField field)
        {
